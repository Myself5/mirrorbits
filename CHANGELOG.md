...
- Clustering support (multiple Mirrorbits instances) [#6](https://github.com/Myself5/mirrorbits/issues/6)
- Support for Redis DB index
- SHA256 and MD5 hashing support (in addition to SHA1) [#4](https://github.com/Myself5/mirrorbits/issues/4)
...
- New mirrorlist template [#15](https://github.com/Myself5/mirrorbits/issues/15)
...
- Improved handling of X-Forwarded-For IP addresses [#23](https://github.com/Myself5/mirrorbits/issues/23)
...
- CLI: fix matching of a mirror ID containing the same substring [#19](https://github.com/Myself5/mirrorbits/issues/19)
- scan: fix an issue causing a constant rehashing of all files [#18](https://github.com/Myself5/mirrorbits/issues/18)
